...
My projects span **AI chatbots, NLP and document-processing pipelines, deep learning, reinforcement learning, and data-intensive applications** running across local and cloud infrastructure.

I enjoy working across the entire AI/ML lifecycle — from **raw and unstructured data to preprocessing, modeling, evaluation, and deployment**.
...
*Building intelligent systems from complex, real-world data.*
